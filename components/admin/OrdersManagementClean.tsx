    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="soft-card p-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-gray-500 mb-0.5">Earning Last Month</p>
              <p className="text-xl font-bold text-gray-900">
        ...
        <div className="soft-card p-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-gray-500 mb-0.5">Earning This Month</p>
              <p className="text-xl font-bold text-gray-900">
      ...
      {/* Orders Table Container - Compact */}
      <div className="soft-card overflow-hidden">
        {/* Table Header with Controls - Compact */}
        ...
        <div className="px-4 py-2.5 border-t border-gray-100 flex items-center justify-between text-xs text-gray-600">
          ...
          <div className="flex items-center gap-1">
            ...
            {[1, 2, 3, '...', 8, 9, 10].map((page, i) => (
              <button
                key={i}
                className={`px-2 py-0.5 rounded text-xs ${page === 1 ? 'bg-blue-600 text-white' : 'hover:bg-gray-50'}`}
              >
                {page}
              </button>
            ))}
